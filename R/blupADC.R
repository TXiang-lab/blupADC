...
for(i in 1:O0O0OOO0O0O0OOOOO0OO){  #每个性状下固定效应的 pos
...
for(i in 1:(length(OOO0OOOOOOOOOOOOO0O0)+1)){  #随机效应的数量 
...
trace_pedigree<-function(input_pedigree=NULL,  #第一列为个体号,第二列为父亲,第三列为母亲
						 ...
						 trace_direction="forward", #backward 为反向
...
error_parent_id=O0O0OOOOOOOOOOO0OOO0$error_parent_id
...
O0O0O0OOO0OOO0O0O0OO_new<-function(id=NULL,ped=NULL){
